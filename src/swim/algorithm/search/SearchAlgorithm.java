...
public abstract class SearchAlgorithm {
    ...
    public SearchAlgorithm(UWVehicleControl vehControl, Simulator sim) {
        this.sim = sim;
    ...
    public void start() {
        ...
        vehControl.setSearchStartTime(vehControl.getCurrentTick());
        System.out.println("Search algorithm started.");
    }
    ...
    protected void stop() {
        ...
        vehControl.reportMissionStageCompleted(MissionStage.TARGET_SEARCH);
        System.out.println("Search algorithm completed.");
    }
    
    protected abstract boolean targetFound();
    ...
    public void applyUpdateRules() {
        if( started ) {
            ...
            System.out.println("Search must be started first!");
        }
    }
