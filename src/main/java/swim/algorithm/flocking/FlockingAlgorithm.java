 ...
 * @author Sherif
 */
public abstract class FlockingAlgorithm {
    ...
    public FlockingAlgorithm(UWVehicleControl vehControl, Simulator sim) {
        this.sim = sim;
    ...
    public void applyUpdateRules() {
        if( started ) {
            ...
            System.out.println("Flocking algorithm must be started first!");
        }
    }
